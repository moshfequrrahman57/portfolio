        ...
        flex items-center justify-between bg-gradient-to-r from-slate-400 to-[#FBF9AC] z-30">
            ...
            <div className="flex md:w-3/4 items-center justify-around">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center m-4 pb-3 md:pb-0 md:m-0 border-b-2 border-slate-500 md:border-none">
                   ...
                   <a href="#" className="nav_item" >
                    <img src="/skill.svg" alt="skill" className="md:hidden w-9 h-9 p-1" />
                    <span className="mr-1 md:px-1">Skill</span>
                   </a>
                   <a href="#" className="nav_item" >
                    <img src="/services.svg" alt="services" className="md:hidden w-9 h-9 p-1" />
                    <span className="mr-1 md:px-1">Services</span>
                   </a>
                   <a href="#" className="nav_item" >
                    <img src="/project-21.svg" alt="projects" className="md:hidden w-9 h-9 p-1" />
                    <span className="mr-1 md:px-1">Projects</span>
                   </a>
                   <a href="#" className="nav_item" >
                    <img src="/about-successful-man-svgrepo-com.svg" alt="about" className="md:hidden w-9 h-9 p-1" />
                    <span className="mr-1 md:px-1">About Me</span>
                   </a>
                   <a href="#" className="nav_item" >
                    <img src="/contact-svgrepo-com.svg" alt="contact" className="md:hidden w-9 h-9 p-1" />
                    <span className="mr-1 md:px-1">Contact</span>
                   </a>  
            ...
            <button className="rounded-full hover:bg-slate-100 md:hover:bg-transparent mx-1">
            <img src="/light-mode-svgrepo-com.svg" alt="dark" width={40} height={40} className="p-1  md:mx-14"/></button>
            <button onClick={()=>{
